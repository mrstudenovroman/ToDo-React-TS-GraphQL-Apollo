...
function Template() {
  ...
  return (
    <WrapperStyled>
      ...
      <InputStyled type="text" value={title} onChange={handleChange('title')} />
      ...
      <InputStyled type="date" value={date} onChange={handleChange('date')} />
      <ButtonStyled type="button" onClick={handleCreateTask}>
        Создать задачу
      </ButtonStyled>
    </WrapperStyled>
  );
